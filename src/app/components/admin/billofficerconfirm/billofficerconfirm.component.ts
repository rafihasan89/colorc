...
@Component({
  selector: 'app-billofficerconfirm',
  templateUrl: './billofficerconfirm.component.html',
  styleUrls: ['./billofficerconfirm.component.css']
})
export class BillofficerconfirmComponent implements OnInit {
  title = 'colorchem';
